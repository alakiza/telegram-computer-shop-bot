...
class FillPermissionsForTelegramUser extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTelegramUser constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.telegram-user',
            'admin.telegram-user.index',
            'admin.telegram-user.create',
            'admin.telegram-user.show',
            'admin.telegram-user.edit',
            'admin.telegram-user.delete',
            'admin.telegram-user.bulk-delete',
        ]);
